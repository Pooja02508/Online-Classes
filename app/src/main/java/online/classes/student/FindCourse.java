...
public class FindCourse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String desiredStateName=getIntent().getStringExtra("State");
        String desiredDistrictName=getIntent().getStringExtra("District");
        String desiredDate=getIntent().getStringExtra("Date");



        firebaseFirestore.collectionGroup("Subject")
                .whereEqualTo("state", desiredStateName)
                .whereEqualTo("district", desiredDistrictName)
                .whereGreaterThanOrEqualTo("startedDate", desiredDate)
                .get()
                ...
                .addOnFailureListener(e -> {
                    ...
                    Log.d("FirestoreQuery", e.getMessage());
                });
        ...
        classesList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String teacherName1 = dataFields[7].substring(dataFields[7].indexOf("Teacher Name: ") + 14);
